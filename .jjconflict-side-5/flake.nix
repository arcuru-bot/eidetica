  ...
  outputs = inputs @ {flake-parts, ...}:
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      perSystem = {
        ...
        mainPkgs = import ./nix/packages/main.nix {inherit craneLib releaseArgs baseArgs pkgs;};
      ...
      in {
        ...
        legacyPackages = {
          ...
          inherit (mainPkgs) eidetica eidetica-lib eidetica-bin xtask;
        ...
        devShells.default = import ./nix/dev-shell.nix {
          ...
          # xtask with completions for development automation
          xtask = mainPkgs.xtask;
        };
      };
    };
}
