> ⚠️ **Status: Superseded**
>
> This design has been superseded by the row-native storage approach.
> See **[Table Store](table.md)** for the current comprehensive design documentation
> covering row-ops format, caching, incremental updates, and cache rebuild coordination.
