...
async fn test_transaction_multiple_subtrees_with_custom_tips() {
    ...
    let users_base = txn_base.get_store::<DocStore>("users").await.unwrap();
    let posts_base = txn_base.get_store::<DocStore>("posts").await.unwrap();
...
async fn test_transaction_custom_tips_subtree_in_ancestors_not_tips() {
    ...
    let settings3 = txn3.get_store::<DocStore>("settings").await.unwrap();
    ...
    let settings4 = txn4.get_store::<DocStore>("settings").await.unwrap();
...
async fn test_transaction_custom_tips_no_subtree_data_in_tips() {
    ...
    let _entry1_id = txn1.commit().await.unwrap();
    ...
    let settings2 = txn2.get_store::<DocStore>("settings").await.unwrap();
    ...
    let metadata3 = txn3.get_store::<DocStore>("metadata").await.unwrap();
    ...
    let metadata4 = txn4.get_store::<DocStore>("metadata").await.unwrap();
