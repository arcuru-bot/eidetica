...
fn test_entry_add_subtree() {
    ...
    let new_entry = builder
        .build()
        .expect("Entry with updated subtree should build successfully");
...
fn test_entry_with_multiple_subtrees() {
    ...
    let entry = builder
        .build()
        .expect("Entry with multiple subtrees should build successfully");
...
fn test_entrybuilder_subtree_parent_methods() {
    ...
    let entry = builder
        .build()
        .expect("Entry with subtree parents should build successfully");
